...
\tikzset{
  ...
  program/.style={
    ...
    draw=black,
    top color=Blue50,
    bottom color=Blue200,
  },
  greencolor/.style={
    top color=Green50,
    bottom color=Green200,
  },
  redcolor/.style={
    top color=Red50,
    bottom color=Red200,
...
\begin{tikzpicture}[node distance=2.3cm]
  \node [file, greencolor] (main_c) at (0,0) {main.c};
  \node [program, right of=main_c] (gcc1) {gcc.exe};
  \node [file, redcolor, right of=gcc1] (mainexe) {main.exe};
  \draw [-o] (main_c) -- (gcc1);
  \draw [->] (gcc1) -- (mainexe);
\end{tikzpicture}
        \end{center}
...
\begin{tikzpicture}[node distance=2.5cm]
  \node [file, greencolor] (main_c) at (0,0) {main.c};
  \node [program, right of=main_c] (gcc1) {gcc.exe};
  \node [file, yellowcolor, right of=gcc1] (main_obj) {main.o};
  \node [file, yellowcolor, below=1cm of main_obj, xshift=2.5cm] (other_obj) {other.o};
  \node [program, right of=main_obj] (ld) {ld.exe};
  \node [file, redcolor, right of=ld] (mainexe) {main.exe};
  \node [file, redcolor, below=1cm of mainexe, xshift=2.5cm] (other_dll) {other.dll};
  \draw [-o] (main_c) -- (gcc1);
  \draw [->] (gcc1) -- (main_obj);
  \draw [-o] (main_obj) -- (ld);
  \draw [-o] (other_obj) -- (ld);
...
\begin{frame}{Процесс компиляции}
  \begin{exampleblock}<1->{Компиляция программы на ЯП Ассемблер: два этапа}
    \begin{center}
\begin{tikzpicture}[node distance=2.5cm]
  \node [file, greencolor] (main_c) at (0,0) {main.asm};
  \node [program, right of=main_c] (gcc1) {nasm.exe};
  \node [file, yellowcolor, right of=gcc1] (main_obj) {main.obj};
  \node [file, yellowcolor, below=1cm of main_obj, xshift=2.5cm] (other_obj) {other.o};
  \node [program, right of=main_obj] (ld) {ld.exe};
  \node [file, redcolor, right of=ld] (mainexe) {main.exe};
  \node [file, redcolor, below=1cm of mainexe, xshift=2.5cm] (other_dll) {other.dll};
