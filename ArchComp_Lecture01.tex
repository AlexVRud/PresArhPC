...
\tikzset{
  ...
  command/.style={ellipse, draw=gray, thick, fill=blue!20!white},
}
...
\begin{tikzpicture}
  ...
  \node[databox=4,text=brown, below=2.5cm of EAX1] (EAX2) {\only<1,3,5>{?}\only<2>{379}\only<4>{2256}\only<6>{567014608}};
  \node[left=0cm of EAX2] (LabelEAX2) {EAX};
