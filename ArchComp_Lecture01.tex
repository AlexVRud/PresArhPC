...
\only<3>{\draw [<-,draw=violet,thick](l7)to[out=180,in=-90] ++(-0.4cm,0.4cm) -- ($(l1)+(-0.4cm,0.7cm)$) to[out=90,in=-90] (EIP);}
\only<4>{\draw [<-,draw=violet,thick](l8)to[out=180,in=-90] ++(-0.4cm,0.4cm) -- ($(l1)+(-0.4cm,0.7cm)$) to[out=90,in=-90] (EIP);}
\only<5>{\draw [<-,draw=violet,thick](l10)to[out=180,in=-90] ++(-0.4cm,0.4cm) -- ($(l1)+(-0.4cm,0.7cm)$) to[out=90,in=-90] (EIP);}
\only<6>{\draw [<-,draw=violet,thick](l11)to[out=180,in=-90] ++(-0.4cm,0.4cm) -- ($(l1)+(-0.4cm,0.7cm)$) to[out=90,in=-90] (EIP);}
\only<7>{\draw [<-,draw=violet,thick](l12)to[out=180,in=-90] ++(-0.4cm,0.4cm) -- ($(l1)+(-0.4cm,0.7cm)$) to[out=90,in=-90] (EIP);}
