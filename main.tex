...
\begin{scope}[xshift=-1*\ByteWidht,yshift=1*\ByteHeight,scale=0.6, every node/.style={scale=0.6}]
  ...
  \only<4>{%
    ...
    \node[databox=4,fill=green!30!white,right=-\pgflinewidth of tmp] (data) {32};
    \node[databox=4,right=-\pgflinewidth of data] (data) {return ptr};
    \node[databox=4,right=-\pgflinewidth of data] (data) {32};
    \node[databox=4,right=-\pgflinewidth of data] (data) {43};
    \node[databox=1,right=-\pgflinewidth of data] (data) {?};
  }
  ...
  \only<7>{%
    \node[databox=5,fill=lightgray,right=-\pgflinewidth of tmp] (tmp) {};
    \node[databox=4,right=-\pgflinewidth of tmp] (data) {return ptr};
    \node[databox=4,right=-\pgflinewidth of data] (data) {32};
    \node[databox=4,right=-\pgflinewidth of data] (data) {43};
    \node[databox=1,right=-\pgflinewidth of data] (data) {?};
  }
...
\end{scope}
%
\only<1>{\draw [->,draw=violet,thick] (EIP) to[out=-90,in=180] ($(-8pt,-1*0.5*\baselineskip+0.25*\baselineskip)$);}
\only<2>{\draw [->,draw=violet,thick] (EIP) to[out=-90,in=180] ($(-8pt,-3*0.5*\baselineskip+0.25*\baselineskip)$);}
\only<3>{\draw [->,draw=violet,thick] (EIP) to[out=-90,in=180] ($(-8pt,-7*0.5*\baselineskip+0.25*\baselineskip)$);}
\only<4>{\draw [->,draw=violet,thick] (EIP) to[out=-90,in=180] ($(-8pt,-8*0.5*\baselineskip+0.25*\baselineskip)$);}
\only<5>{\draw [->,draw=violet,thick] (EIP) to[out=-90,in=180] ($(-8pt,-10*0.5*\baselineskip+0.25*\baselineskip)$);}
\only<6>{\draw [->,draw=violet,thick] (EIP) to[out=-90,in=180] ($(-8pt,-11*0.5*\baselineskip+0.25*\baselineskip)$);}
\only<7>{\draw [->,draw=violet,thick] (EIP) to[out=-90,in=180] ($(-8pt,-12*0.5*\baselineskip+0.25*\baselineskip)$);}
\only<8>{\draw [->,draw=violet,thick] (EIP) to[out=-90,in=180] ($(-8pt,-4*0.5*\baselineskip+0.25*\baselineskip)$);}
\only<9>{\draw [->,draw=violet,thick] (EIP) to[out=-90,in=180] ($(-8pt,-5*0.5*\baselineskip+0.25*\baselineskip)$);}
%
