...
\only<2>{
        \draw[scale=0.6,draw=red] (2pt+16*8.8pt,-2pt-24*20pt) rectangle ++(8*8.8pt+1pt,-1*16pt);
        \draw[scale=0.6,draw=red] (2pt+51*8.8pt,-2pt-24*20pt) rectangle ++(10*8.8pt+1pt,-1*16pt);
};
      \end{tikzpicture}
    \end{figure}
  \end{block}
