...
\begin{verbatim}
00000000  4c 01 02 00 5e 13 ee 54  a5 00 00 00 0c 00 00 00  |L...^..T........|
00000010  00 00 00 00 2e 74 65 78  74 00 00 00 00 00 00 00  |.....text.......|
00000020  00 00 00 00 12 00 00 00  64 00 00 00 76 00 00 00  |........d...v...|
00000030  00 00 00 00 03 00 00 00  20 00 50 60 2e 64 61 74  |........ .P`.dat|
00000040  61 00 00 00 00 00 00 00  00 00 00 00 11 00 00 00  |a...............|
00000050  94 00 00 00 a5 00 00 00  00 00 00 00 00 00 00 00  |................|
00000060  40 00 30 c0 68 00 00 00  00 e8 00 00 00 00 31 c0  |@.0.h.........1.|
00000070  50 e8 00 00 00 00 01 00  00 00 04 00 00 00 06 00  |P...............|
00000080  06 00 00 00 08 00 00 00  14 00 0e 00 00 00 07 00  |................|
00000090  00 00 14 00 48 65 6c 6c  6f 20 57 6f 72 6c 64 21  |....Hello World!|
000000a0  21 21 0d 0a 00 2e 66 69  6c 65 00 00 00 00 00 00  |!!....file......|
000000b0  00 fe ff 00 00 67 01 6c  61 62 2d 77 31 2d 68 65  |.....g.lab-w1-he|
000000c0  6c 6c 6f 2e 61 73 6d 00  00 2e 74 65 78 74 00 00  |llo.asm...text..|
000000d0  00 00 00 00 00 01 00 00  00 03 01 12 00 00 00 03  |................|
000000e0  00 00 00 00 00 00 00 00  00 00 00 00 00 2e 64 61  |..............da|
000000f0  74 61 00 00 00 00 00 00  00 02 00 00 00 03 01 11  |ta..............|
00000100  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  |................|
00000110  00 2e 61 62 73 6f 6c 75  74 00 00 00 00 ff ff 00  |..absolut.......|
00000120  00 03 00 00 00 00 00 04  00 00 00 00 00 00 00 00  |................|
00000130  00 00 00 02 00 5f 70 72  69 6e 74 66 00 00 00 00  |....._printf....|
00000140  00 00 00 00 00 02 00 5f  6d 61 69 6e 00 00 00 00  |......._main....|
00000150  00 00 00 01 00 00 00 02  00 6d 73 67 00 00 00 00  |.........msg....|
00000160  00 00 00 00 00 02 00 00  00 03 00 40 66 65 61 74  |...........@feat|
00000170  2e 30 30 01 00 00 00 ff  ff 00 00 03 00 13 00 00  |.00.............|
00000180  00 5f 45 78 69 74 50 72  6f 63 65 73 73 40 34 00  |._ExitProcess@4.|
\end{verbatim}
          \end{minipage}
        };
      \end{tikzpicture}
...
\begin{verbatim}
     ...
     6                                  _main:
     7 00000000 68[00000000]                    push    msg
     8 00000005 E8(00000000)                    call    _printf
     9
    10 0000000A 31C0                            xor     eax, eax
    11 0000000C 50                              push    eax
    12 0000000D E8(00000000)                    call    _ExitProcess@4
    13                                  section .data
    14 00000000 48656C6C6F20576F72-     msg     db "Hello World!!!", 13, 10, 0
    15 00000009 6C642121210D0A00
\end{verbatim}
          \end{minipage}
        };
      \end{tikzpicture}
