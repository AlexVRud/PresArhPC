...
\node<5->[recept, align=center, fill=green!50, right of=p1to2soup] (p2t) {Меню};
\node<5->[recept, fill=green!20, below=-1pt of p2t] (p2milk) {Молоко};
\node<5->[recept, fill=blue!20, below=-1pt of p2milk] (p2soup) {Суп};

\node<5->[recept, align=center, fill=green!50, right of=p2to3omelette] (p22t) {Меню};
\node<5->[recept, fill=yellow!20, below=-1pt of p22t] (p22tee) {Чай};
\node<5->[recept, fill=red!20, below=-1pt of p22tee] (p22omelette) {Омлет};

\node<6->[recept, rounded corners, fill=white, below=0.5cm of p2soup] (p3merge) {\small Слияние};

\node<7->[recept, align=center, fill=green!50, right of=p3merge, yshift=2cm] (p4t) {Меню};
\node<7->[recept, fill=yellow!20, below=-1pt of p4t] (p4tee) {Чай};
\node<7->[recept, fill=blue!20, below=-1pt of p4tee] (p4soup) {Суп};
\node<7->[recept, fill=red!20, below=-1pt of p4soup] (p4omelette) {Омлет};

\node<7->[recept, align=center, fill=green!50, below=1.4cm of p4soup] (p24t) {Меню};
\node<7->[recept, fill=yellow!20, below=-1pt of p24t] (p24tee) {Чай};
\node<7->[recept, fill=red!20, below=-1pt of p24tee] (p24omelette) {Омлет};
\node<7->[recept, fill=blue!20, below=-1pt of p24omelette] (p24soup) {Суп};
...
\draw<7->[->] (p3merge) to[out=10,in=180] node[above left]{?} (p4t);
\draw<7->[->] (p3merge) to[out=-10,in=180] node[above]{?} (p24t);
